...
export default function ExporterSuccessStoriesPage() {
  const { user } = useAuth();
  ...
  return (
    <Box sx={{ 
      ...
      {/* Header */}
      <Box sx={{ mb: 3 }}>
        <Typography variant="h4" fontWeight="bold" gutterBottom className="text-gray-900 dark:text-white">
          Success Stories
        </Typography>
        <Typography variant="body2" className="text-gray-600 dark:text-gray-300">
          Share success stories about your export partnerships
        </Typography>
      </Box>
